 ...
 <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="card shadow mb-4">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($mahasiswa as $mhs) : ?>
                                                        <tr>
                                                            ...
                                                            <td width="20%">
                                                                <?php echo anchor('admin/detail_mahasiswa/' .$mhs->id, '<div class="btn btn-sm btn-outline-primary mb-1"><i class="fas fa-list"></i></div>') ?>
                                                                <?php echo anchor('admin/update_mahasiswa/' .$mhs->id, '<div class="btn btn-sm btn-outline-success  mb-1"><i class="fas fa-edit"></i></div>') ?>
                                                                <a href="<?php echo base_url('admin/delete_mahasiswa/' .$mhs->id ,"") ?>" class="btn btn-outline-danger btn-sm mb-1" onclick="return confirm('Yakin menghapus data yg dipilih?');"><i class="fas fa-trash"></i></a>
                                                            </td>
                                                        </tr>
                                                    <?php endforeach; ?>
                                                </tbody>
                    ...
                    <p class="ml-5">total <?= $jumlah_mahasiswa ?></p>
                </div>
